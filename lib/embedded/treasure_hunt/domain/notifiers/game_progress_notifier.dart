  ...
  List<Say> getAlchemistDialog() {
    switch (state) {
      ...
      case GameProgress.start:
        return [
          Say(
            text: [const TextSpan(text: 'Hello mam, do you need help?')],
          ...
          Say(
            text: [const TextSpan(text: 'Say less ma.')],
            personSayDirection: PersonSayDirection.LEFT,
            person: Globals.imageAssets.dwarf,
          ),
        ];
      ...
      case GameProgress.elixerCollected:
        return [
          Say(
            text: [
              const TextSpan(text: 'Don\'t keep my husband waiting please!'),
            ],
            personSayDirection: PersonSayDirection.RIGHT,
            person: Globals.imageAssets.alchemist,
          ),
  ...
  List<Say> getBlacksmithDialog() {
    switch (state) {
      ...
      case GameProgress.charcoalCollected:
        return [
          Say(
            text: [const TextSpan(text: 'Well what are you waiting for lad?')],
            personSayDirection: PersonSayDirection.RIGHT,
            person: Globals.imageAssets.blacksmith,
          ),
        ];
