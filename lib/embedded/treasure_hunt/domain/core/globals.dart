...
class _ImageAssets {
  static const _images = 'assets/treasure_hunt/images/';

  final dwarf = Image.asset('${_images}dwarf_warrior/idle/0.png', scale: 0.3);

  final alchemist = Image.asset('${_images}alchemist/0.png', scale: 0.5);

  final blacksmith = Image.asset('${_images}blacksmith/0.png', scale: 0.5);
...
class _Input {
  static const path = 'assets/treasure_hunt/images/input/';
...
class _Lottie {
  final gameOver = 'assets/treasure_hunt/lotties/game_over.json';
  final gameWon = 'assets/treasure_hunt/lotties/game_won.json';
}
