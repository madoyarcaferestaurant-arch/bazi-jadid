...
class HeadlessHorseman extends PlatformEnemy
  ...
  HeadlessHorseman(this.ref, {required super.position})
    : super(
        life: 200,
        ...
        if (canGiveDamage(player)) {
          simpleAttackMelee(
            ...
            execute: () => playOnceOther(
              onStart: () =>
                  playSoundEffect(Globals.audio.headlessHorsemanAttack, ref),
  ...
  void onDie() {
    playOnceOther(
      ...
      onStart: () => playSoundEffect(Globals.audio.headlessHorsemanDie, ref),
      onFinish: () => dropItem(),
    );
    super.onDie();
  }
  ...
  void onReceiveDamage(AttackOriginEnum attacker, double damage, identify) {
    if (canReceiveDamage(gameRef.player!)) {
      if (damage < life) {
        playOnceOther(
          onStart: () =>
              playSoundEffect(Globals.audio.headlessHorsemanHurt, ref),
