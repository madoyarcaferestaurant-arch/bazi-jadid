...
import 'package:madoyar_app/embedded/treasure_hunt/domain/core/extensions/platform_enemy_extensions.dart';
...
class Minotaur extends PlatformEnemy
  ...
  Minotaur(this.ref, {required super.position})
    : super(
        life: 100,
        ...
        animation: PlatformAnimations(
          ...
          others: {
            ...
            PlatformAnimationsOther.death.name: SpriteAnimations.minotaur.death,
          },
        ),
      ) {
        ...
        if (canGiveDamage(player)) {
          simpleAttackMelee(
            ...
            execute: () => playOnceOther(
              onStart: () => playSoundEffect(Globals.audio.minotaurAttack, ref),
  ...
  void onDie() {
    playOnceOther(
      ...
      onStart: () => playSoundEffect(Globals.audio.minotaurDie, ref),
      onFinish: () => dropItem(),
    );
    super.onDie();
  }
  ...
  void onReceiveDamage(AttackOriginEnum attacker, double damage, identify) {
    if (canReceiveDamage(gameRef.player!)) {
      if (damage < life) {
        playOnceOther(
          onStart: () => playSoundEffect(Globals.audio.minotaurHurt, ref),
