...
import 'package:madoyar_app/embedded/treasure_hunt/domain/core/enums/platform_animations_other.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/core/extensions/direction_animation_extensions.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/core/extensions/game_component_extensions.dart';
...
import 'package:madoyar_app/embedded/treasure_hunt/domain/core/mixins/screen_boundary_checker.dart';
import 'package:madoyar_app/embedded/treasure_hunt/data/services/modal_service.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/core/providers.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/items/charcoal.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/items/coin.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/items/elixer.dart';
...
class DwarfWarrior extends PlatformPlayer
  ...
  DwarfWarrior(this.ref, {required super.position})
    : super(
        speed: 100,
        countJumps: 2,
  ...
  void onReceiveDamage(AttackOriginEnum attacker, double damage, identify) {
    if (damage < life) {
      playOnceOther(
        onStart: () => playSoundEffect(Globals.audio.dwarfWarriorHurt, ref),
      ...
      onFinish: () {
        switch (ref.read(Providers.gameProgressProvider)) {
          ...
          case GameProgress.start:
            ref
                .read(Providers.gameProgressProvider.notifier)
                .updateProgress(GameProgress.searching);
            break;
          case GameProgress.searching:
            break;
          case GameProgress.charcoalCollected:
            ref
                .read(Providers.inventoryProvider.notifier)
                .removeItem(Charcoal().id);
            ...
            ref
                .read(Providers.gameProgressProvider.notifier)
                .updateProgress(GameProgress.elixerCollected);
            break;
      ...
      onFinish: () {
        switch (ref.read(Providers.gameProgressProvider)) {
          ...
          case GameProgress.searching:
            ...
            ref
                .read(Providers.gameProgressProvider.notifier)
                .updateProgress(GameProgress.charcoalCollected);
