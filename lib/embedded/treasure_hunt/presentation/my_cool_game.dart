...
import 'package:madoyar_app/embedded/treasure_hunt/domain/core/enums/joystick_actions.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/core/enums/overlays.dart';
...
import 'package:madoyar_app/embedded/treasure_hunt/presentation/backgrounds/parallax_background.dart';
import 'package:madoyar_app/embedded/treasure_hunt/presentation/overlays/audio_settings_button_overlay.dart';
import 'package:madoyar_app/embedded/treasure_hunt/presentation/overlays/audio_settings_overlay.dart';
import 'package:madoyar_app/embedded/treasure_hunt/presentation/overlays/game_over_overlay.dart';
import 'package:madoyar_app/embedded/treasure_hunt/presentation/overlays/game_won_overlay.dart';
import 'package:madoyar_app/embedded/treasure_hunt/presentation/overlays/inventory_overlay.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/enemies/headless_horseman.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/enemies/lizardman.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/enemies/minotaur.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/npcs/alchemist.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/npcs/blacksmith.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/objects/bonfire.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/objects/chest.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/objects/plant.dart';
import 'package:madoyar_app/embedded/treasure_hunt/domain/entities/objects/world_object.dart';
import 'package:madoyar_app/embedded/treasure_hunt/presentation/overlays/start_overlay.dart';
...
class _MyCoolGameState extends State<MyCoolGame> {
  static const _mapName = 'assets/treasure_hunt/images/map.json';
  ...
  Widget build(BuildContext context) => BonfireWidget(
    ...
    playerControllers: [
      ...
      Joystick(
        directional: JoystickDirectional(
          spriteKnobDirectional: Sprite.load(Globals.input.leftJoystick),
          size: _joystickSize,
    ...
    overlayBuilderMap: {
      Overlays.start.name: (context, game) => StartOverlay(
        onStart: () {
          ...
          widget.ref
              ...
              .updateProgress(GameProgress.start);
        },
      ),
      ...
      Overlays.gameOver.name: (context, game) =>
          GameOverOverlay(onReset: _onReset),
      Overlays.gameWon.name: (context, game) =>
          GameWonOverlay(onReset: _onReset),
    ...
    player: DwarfWarrior(widget.ref, position: Vector2.all(20)),
    ...
    map: WorldMapBySpritefusion(
      ...
      objectsBuilder: {
        'Alchemist': (properties) => Alchemist(position: properties),
        'Blacksmith': (properties) => Blacksmith(position: properties),
        'Bonfire': (properties) => Bonfire(widget.ref, position: properties),
        'Chest': (properties) => Chest(widget.ref, position: properties),
        'Headless Horseman': (properties) =>
            HeadlessHorseman(widget.ref, position: properties),
        'Lizardman': (properties) =>
            Lizardman(widget.ref, position: properties),
        'Minotaur': (properties) => Minotaur(widget.ref, position: properties),
        'Plant': (properties) => Plant(position: properties),
        'World Object': (properties) => WorldObject(position: properties),
      },
    ),
  );
  ...
  void _onReset() {
    widget.ref
        .read(Providers.gameProgressProvider.notifier)
        .updateProgress(GameProgress.menu);
