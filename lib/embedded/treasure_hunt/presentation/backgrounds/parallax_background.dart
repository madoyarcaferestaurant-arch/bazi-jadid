...
class ParallaxBackground extends GameBackground {
  static const _sky = 'assets/treasure_hunt/images/background/sky.png';
  static const _clouds = 'assets/treasure_hunt/images/background/clouds.png';
  static const _mountains =
      'assets/treasure_hunt/images/background/mountains.png';
  static const _hills = 'assets/treasure_hunt/images/background/hills.png';
  ...
  void _addParallax() async {
    _skyAndClouds = await loadParallaxComponent(
      [ParallaxImageData(_sky), ParallaxImageData(_clouds)],
    ...
    _mountainsAndHills = await loadCameraParallaxComponent(
      [ParallaxImageData(_mountains), ParallaxImageData(_hills)],
      baseVelocity: Vector2(10, 0),
